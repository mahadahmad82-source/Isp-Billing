...
const BRAND_COLORS = ['#22d3ee', '#6366f1', '#a855f7', '#3b82f6'];
...
const VideoBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full pointer-events-none overflow-hidden z-0 bg-[#040814]">
      ...
      <div className="absolute rounded-full" style={{ width: 300, height: 300, top: '38%', right: '-5%', background: 'radial-gradient(circle, rgba(168,85,247,0.30), transparent 70%)', filter: 'blur(50px)', animation: 'bcFloatB 20s ease-in-out infinite' }} />
      <div className="absolute rounded-full" style={{ width: 260, height: 260, bottom: '8%', left: '18%', background: 'radial-gradient(circle, rgba(34,211,238,0.28), transparent 70%)', filter: 'blur(50px)', animation: 'bcFloatC 14s ease-in-out infinite' }} />
      ...
      <div className="absolute inset-0" style={{ background: 'radial-gradient(circle at center, transparent 25%, #040814 88%)', opacity: 0.85 }} />
