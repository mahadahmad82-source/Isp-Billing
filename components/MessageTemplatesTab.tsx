...
const PLACEHOLDER_HINTS: Record<string, string[]> = {
  ...
  receipt_share: ['businessName', 'transactionRef', 'date', 'name', 'method', 'period', 'advance', 'paidAmount', 'balance'],
  receipt_share_recovery: ['businessName', 'transactionRef', 'date', 'name', 'period', 'advance', 'paidAmount', 'nextDue'],
