        ...
        <div className="space-y-6 pb-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {!readOnly && isCurrentMonth && (
              <>
                <button onClick={() => { resetForm(); setShowForm(true); }} style={{background:"var(--color-primary,#5a4ff0)"}} className="text-white py-5 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-2xl flex items-center justify-center gap-2 active:scale-95 duration-200 hover:opacity-90 transition-opacity col-span-1">
                ...
                <button onClick={() => setShowQuickActivate(true)} style={{background:"var(--color-accent,#7c3aed)"}} className="text-white py-5 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-2xl flex items-center justify-center gap-2 active:scale-95 duration-200 hover:opacity-90 transition-opacity col-span-1">
                ...
                <div className="flex items-center gap-2 justify-end">
                  <button onClick={downloadCustomerTemplate} className="p-4 bg-white dark:bg-[#0f172a] text-slate-700 dark:text-slate-200 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg active:scale-95 transition-all hover:bg-slate-50 dark:hover:bg-slate-800 flex-1 flex items-center justify-center" title="Download Template">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                  </button>
                  <button onClick={() => fileInputRef.current?.click()} className="p-4 bg-white dark:bg-[#0f172a] text-slate-700 dark:text-slate-200 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg active:scale-95 transition-all hover:bg-slate-50 dark:hover:bg-slate-800 flex-1 flex items-center justify-center" title="Import Excel">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
                  </button>
                  <button onClick={handleExportExcel} className="p-4 bg-white dark:bg-[#0f172a] text-slate-700 dark:text-slate-200 rounded-2xl border border-slate-200 dark:border-white/5 shadow-lg active:scale-95 transition-all hover:bg-slate-50 dark:hover:bg-slate-800 flex-1 flex items-center justify-center" title="Export Excel">
                ...
                <button onClick={() => setShowImportHistory(true)} className="bg-white dark:bg-[#0f172a] text-indigo-600 dark:text-indigo-400 py-5 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-lg border border-indigo-100 dark:border-indigo-500/20 hover:bg-indigo-50 dark:hover:bg-indigo-500/5 transition-colors flex items-center justify-center gap-2 active:scale-95 duration-200">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg> IMPORT FROM HISTORY
                </button>
                <button onClick={() => { if(selectedIds.length === 0){ setAlertConfig({title:'No Selection',message:'Pehle users select karein phir plan change karein.',type:'info'}); return; } setBulkNewPlan(availablePlans[0]||''); setShowBulkChangePlan(true); }} className="bg-amber-500 hover:bg-amber-600 text-white py-5 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-lg border border-amber-400 active:scale-95 duration-200 flex items-center justify-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg> CHANGE PLAN {selectedIds.length > 0 && <span className="bg-white/20 px-2 py-0.5 rounded-full text-[9px]">{selectedIds.length}</span>}
                </button>
              </>
            )}
          </div>
