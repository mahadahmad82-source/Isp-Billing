                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {!item.hasPaid ? (
                          <>
                             ...
                             <button onClick={() => { window.location.href = `tel:${item.phone}`; }} title="Call Customer" aria-label={`Call ${item.name}`} className="p-2 rounded-xl text-slate-400 dark:text-slate-500 hover:bg-blue-50 dark:hover:bg-blue-500/10 hover:text-blue-600 dark:hover:text-blue-400 transition-all">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-3xl border border-slate-100 dark:border-white/5 text-slate-900 dark:text-slate-100">
                  ...
                  {(() => {
                    ...
                    if (!showAmounts) return <p className="text-2xl font-black text-slate-400">Rs. ••••••</p>;
