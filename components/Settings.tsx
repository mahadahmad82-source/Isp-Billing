      ...
      <div className="grid grid-cols-1 gap-10">
        ...
        <div className="bg-white dark:bg-[#0f172a] p-10 rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-2xl space-y-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">NetBot WhatsApp Bot</h4>
          ...
          <div>
            ...
            />
            <p className="text-[10px] text-slate-400 mt-1.5 font-medium">
              Bot introduction preview: <span className="font-black text-emerald-500">"I am {localSettings.ayeshaBotName || 'NetBot'}..."</span>
            </p>
          </div>
