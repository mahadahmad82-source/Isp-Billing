...
export interface AppNotification {
  id: string;
  type: 'EXPIRY' | 'OVERDUE' | 'SYSTEM' | 'RECOVERY' | 'PAYMENT' | 'ATTENDANCE_IN' | 'ATTENDANCE_OUT' | 'COMPLAINT_RESOLVED' | 'COMPLAINT_ASSIGNED' | 'COMPLAINT_REVIEW_REQUIRED' | 'COMPLAINT_FEEDBACK_SKIPPED' | 'TEAM_MESSAGE';
